...
//  Lambda
//
//  Created by Maxim Dmitrochenko on 28.03.2024.
//
...
class AlertManager {
    ...
    private static func showBasicAlert(on vc: UIViewController, title: String, message: String? = nil) {
...
extension AlertManager {
    ...
    public static func showRegistrationErrorAlert(on vc: UIViewController) {
        self.showBasicAlert(on: vc, title: "Unknown Registration Error")
    }
...
extension AlertManager {
    ...
    public static func showPasswordResetSent(on vc: UIViewController) {
        self.showBasicAlert(on: vc, title: "Password Reset Sent")
    }
...
extension AlertManager {
    ...
    public static func showUnknownFetchingUserError(on vc: UIViewController) {
        self.showBasicAlert(on: vc, title: "Unknown Error Fetching User")
    }
}
...
extension AlertManager {
    ...
    public static func showUpdateUserImageError(on vc: UIViewController, with error: Error) {
        self.showBasicAlert(on: vc, title: "Error Update User Image", message: "\(error.localizedDescription)")
    }
    
    public static func showUnknownUpdateUserImageError(on vc: UIViewController) {
        self.showBasicAlert(on: vc, title: "Unknown Error Update User Image")
    }
}
