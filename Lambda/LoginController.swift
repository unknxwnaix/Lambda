...
class LoginController: UIViewController {
    ...
    private let newUserButton = CustomButton(title: "New User? Create an account.", fontSize: .med)
    ...
    private func setupUI() {
        ...
        NSLayoutConstraint.activate([
            ...
            self.forgotPasswordButton.heightAnchor.constraint(equalToConstant: 22),
